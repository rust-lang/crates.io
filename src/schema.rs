...
table! {
    ...
    crates (id) {
        ...
        /// The `highest_version` column of the `crates` table.
        ///
        /// Its SQL type is `Nullable<Varchar>`.
        ///
        /// (Automatically generated by Diesel.)
        highest_version -> Nullable<Varchar>,
        /// The `highest_stable_version` column of the `crates` table.
        ///
        /// Its SQL type is `Nullable<Varchar>`.
        ///
        /// (Automatically generated by Diesel.)
        highest_stable_version -> Nullable<Varchar>,
        /// The `newest_version` column of the `crates` table.
        ///
        /// Its SQL type is `Nullable<Varchar>`.
        ///
        /// (Automatically generated by Diesel.)
        newest_version -> Nullable<Varchar>,
    }
}
