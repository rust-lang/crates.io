...
table! {
    ...
    sessions (id) {
        ...
        /// (Automatically generated by Diesel.)
        user_id -> Int4,
        /// The `hashed_token` column of the `sessions` table.
        ///
        /// Its SQL type is `Bytea`.
        ///
        /// (Automatically generated by Diesel.)
        ...
        /// (Automatically generated by Diesel.)
        created_at -> Timestamp,
        /// The `last_used_at` column of the `sessions` table.
        ///
        /// Its SQL type is `Timestamp`.
        ///
        /// (Automatically generated by Diesel.)
        last_used_at -> Timestamp,
        /// The `revoked` column of the `sessions` table.
        ///
        /// Its SQL type is `Bool`.
        ///
        /// (Automatically generated by Diesel.)
        revoked -> Bool,
        /// The `last_ip_address` column of the `sessions` table.
        ///
        /// Its SQL type is `Inet`.
        ///
        /// (Automatically generated by Diesel.)
        last_ip_address -> Inet,
        /// The `last_user_agent` column of the `sessions` table.
        ///
        /// Its SQL type is `Varchar`.
        ///
        /// (Automatically generated by Diesel.)
