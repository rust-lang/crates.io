...
<TextContent boxed>
  ...
  <p>
    ...
    <a href="https://doc.rust-lang.org/cargo/reference/registry-index.html">Cargo index format</a>. The sparse index
  ...
  <p>
    ...
    <a href="https://doc.rust-lang.org/cargo/reference/registry-index.html#index-files">index files</a>. For example,
    information on the
    <code>base64</code>
  ...
  <p>No rate limits are required to use data from the sparse crate index.</p>
  ...
  <p>
    ...
    <a href="https://github.com/rust-lang/crates.io-index">
      <code>rust-lang/crates.io-index</code>
      repository on GitHub</a
    >. This remains available for use, and may be a more efficient way of accessing crate metadata for projects that
    require most or all crates to be included than the sparse index.
  </p>

  <p>
    As the Git index is hosted on GitHub, GitHub's
    <a href="https://docs.github.com/en/site-policy/acceptable-use-policies/github-acceptable-use-policies"
  ...
  <ul>
    ...
    <li>
      ...
      The latest version updates on crates.io (the past 60 minutes, but at least 100 versions).
    </li>
    <li>
      e.g.
      <a href="https://static.crates.io/rss/crates/serde.xml">https://static.crates.io/rss/crates/serde.xml</a>:<br />
      The latest version updates of the serde crate (the past 24 hours, but at least 10 versions).
    </li>
  </ul>
  ...
  <p>
    crates.io database dumps contain all information available through the crates.io API in a single download. They are
    updated every 24 hours.
  </p>

  <p>
    The latest dump is available at the address
    <a href="https://static.crates.io/db-dump.tar.gz">https://static.crates.io/db-dump.tar.gz</a>. Information on using
    the dump is contained in the tarball. You can find the changelog for database dumps in
  ...
  <p>
    ...
    <a href="https://crates.io/api/openapi.json">https://crates.io/api/openapi.json</a>. Should you be unable to use one
    of the previous options, you are welcome to use the crates.io API provided you abide by the following limits:
  </p>
  ...
  <ol>
    ...
    <li>
      ...
      header that identifies your application. We strongly suggest providing a way for us to contact you (whether through
      a repository, or an e-mail address, or whatever is appropriate) so that we can reach out to work with you should there
      be issues.
    </li>
  </ol>
  ...
  <p>
    ...
    <a href="mailto:help@crates.io">help@crates.io</a>, or by starting
    <a href="https://github.com/rust-lang/crates.io/discussions">a discussion on GitHub</a>, and we'll be happy to
