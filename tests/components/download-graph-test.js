        ...
        datasets: [
          {
            ...
            data: [
              { x: isDate('2020-12-30'), y: 30520 },
              { x: isDate('2020-12-29'), y: 31631 },
          ...
          },
          {
            ...
            cubicInterpolationMode: 'monotone',
            data: [
              { x: isDate('2020-12-30'), y: 36745 },
              { x: isDate('2020-12-29'), y: 33242 },
              { x: isDate('2020-12-28'), y: 19981 },
              { x: isDate('2020-12-27'), y: 19064 },
              { x: isDate('2020-12-26'), y: 0 },
              { x: isDate('2020-12-25'), y: 0 },
              { x: isDate('2020-12-24'), y: 0 },
              { x: isDate('2020-12-23'), y: 0 },
