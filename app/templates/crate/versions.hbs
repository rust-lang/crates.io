...
<div class="results-meta">
  <span class="page-description text--small {{if (and this.loadMoreTask.isRunning (not this.sortedVersions)) 'is-empty'}}"
...
{{#if this.sortedVersions}}
  <ul class="list">
    {{#each this.sortedVersions as |version|}}
      <li>
        <VersionList::Row @version={{version}} class="row" data-test-version={{version.num}} />
      </li>
    {{/each}}
  </ul>
