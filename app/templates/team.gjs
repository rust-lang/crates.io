<PageHeader class="header" data-test-heading>
  <UserAvatar @user={{this.model.team}} @size="medium" class="avatar" data-test-avatar />
  <div>
    <div class="header-row">
      <h1 data-test-org-name>
        {{ this.model.team.org_name }}
      </h1>
      <UserLink @user={{this.model.team}} class="github-link" data-test-github-link>
...
<CrateList @crates={{this.model.crates}} class="list" />
