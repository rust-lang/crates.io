...
diesel::table! {
    ...
    versions (id) {
        ...
        /// (Automatically generated by Diesel.)
        yanked -> Bool,
        /// SHA256 checksum of the zip source archive manifest, or `NULL` if it has not been built yet.
        zip_json_sha256 -> Nullable<Bytea>,
        /// SHA256 checksum of the zip source archive, or `NULL` if it has not been built yet.
        zip_sha256 -> Nullable<Bytea>,
    }
}
...
diesel::joinable!(reverse_dependencies -> versions (version_id));
