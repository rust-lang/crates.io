...
impl GitHubClaims {
    ...
    /// Extract the workflow filename from the [`job_workflow_ref`](Self::job_workflow_ref)
    /// field or return `None` if the filename cannot be extracted.
    pub fn workflow_filename(&self) -> Option<&str> {
        extract_workflow_filename(&self.job_workflow_ref)
    }
}
...
mod tests {
    ...
    fn test_decode_missing_jti() -> anyhow::Result<()> {
        ...
        assert_compact_debug_snapshot!(error, @r#"Error(Json(Error("missing field `jti`", line: 1, column: 255)))"#);
    ...
    fn test_decode_missing_repo() -> anyhow::Result<()> {
        ...
        let error = GitHubClaims::decode(&jwt, AUDIENCE, &DECODING_KEY).unwrap_err();
        assert_compact_debug_snapshot!(error, @r#"Error(Json(Error("missing field `repository`", line: 1, column: 240)))"#);
    ...
    fn test_decode_missing_owner_id() -> anyhow::Result<()> {
        ...
        let error = GitHubClaims::decode(&jwt, AUDIENCE, &DECODING_KEY).unwrap_err();
        assert_compact_debug_snapshot!(error, @r#"Error(Json(Error("missing field `repository_owner_id`", line: 1, column: 247)))"#);
    ...
    fn test_decode_missing_workflow() -> anyhow::Result<()> {
        ...
        let error = GitHubClaims::decode(&jwt, AUDIENCE, &DECODING_KEY).unwrap_err();
        assert_compact_debug_snapshot!(error, @r#"Error(Json(Error("missing field `job_workflow_ref`", line: 1, column: 185)))"#);
    ...
    fn test_decode_missing_exp() -> anyhow::Result<()> {
        ...
        let error = GitHubClaims::decode(&jwt, AUDIENCE, &DECODING_KEY).unwrap_err();
        assert_compact_debug_snapshot!(error, @r#"Error(Json(Error("missing field `exp`", line: 1, column: 257)))"#);
    ...
    fn test_decode_missing_iat() -> anyhow::Result<()> {
        ...
        let error = GitHubClaims::decode(&jwt, AUDIENCE, &DECODING_KEY).unwrap_err();
        assert_compact_debug_snapshot!(error, @r#"Error(Json(Error("missing field `iat`", line: 1, column: 257)))"#);
