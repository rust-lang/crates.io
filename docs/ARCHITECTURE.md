...
and the conventions new API endpoints should follow are documented in
[`docs/API-DESIGN.md`](https://github.com/rust-lang/crates.io/blob/master/docs/API-DESIGN.md).
